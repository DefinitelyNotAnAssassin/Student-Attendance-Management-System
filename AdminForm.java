...
public class AdminForm extends javax.swing.JFrame {
  ...
  public AdminForm() {
    ...
    db.connect();
    String sql =
        "SELECT s.student_number, c.course_name, a.attendance_id, a.is_present, a.attendance_date "
            + " FROM Attendance a INNER JOIN Students s ON a.student_id = s.student_number INNER"
            + " JOIN Courses c ON a.course_id = c.course_id ORDER BY attendance_id DESC";
    ...
    try {
      while (set.next()) {
        Object[] row = {
          set.getInt("a.attendance_id"),
          set.getString("student_number"),
          set.getString("course_name"),
          set.getString("attendance_date"),
          set.getInt("is_present")
        };
  ...
  private void initComponents() {
    ...
    jLabel6.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Icon/Management_1.png"))); // NOI18N
    ...
    jLabel4.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Icon/Logout.png"))); // NOI18N
    ...
    jLabel10.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Icon/Registration.png"))); // NOI18N
    ...
    jLabel12.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Icon/Edit File.png"))); // NOI18N
    ...
    jLabel14.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Icon/Logo_white.png"))); // NOI18N
    ...
    jLabel7.addMouseMotionListener(
    ...
    AdminPanel.add(
        HeaderPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 1040, 30));
    ...
    jTable2.setModel(
        new javax.swing.table.DefaultTableModel(
            ...
            new String[] {"Course ID", "Course Name", "Course Code"}));
    ...
    jTable3.setModel(
        new javax.swing.table.DefaultTableModel(
            ...
            new String[] {"Student Number", "First Name", "Last Name", "Birthdate", "Email"}));
    ...
    studentnumber.setFont(
        studentnumber.getFont().deriveFont(studentnumber.getFont().getSize() + 2f));
    studentnumber.setBorder(null);
    studentnumber.addActionListener(
    ...
    AdminPanel.add(
        CenterePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 1040, 670));
    ...
    layout.setHorizontalGroup(
        layout
            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(
                AdminPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 1153, Short.MAX_VALUE));
  ...
  private void jLabel7MouseDragged(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_jLabel7MouseDragged
  ...
  private void jLabel7MouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_jLabel7MouseClicked
    System.exit(0);
  } // GEN-LAST:event_jLabel7MouseClicked

  private void jLabel7MouseEntered(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_jLabel7MouseEntered
    jLabel7.setForeground(Color.RED);
  } // GEN-LAST:event_jLabel7MouseEntered

  private void jLabel7MouseExited(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_jLabel7MouseExited
  ...
  private void btn2MouseClicked(java.awt.event.MouseEvent evt) { // GEN-FIRST:event_btn2MouseClicked
    ...
    try {
      while (set.next()) {
        Object[] row = {
          set.getInt("course_id"), set.getString("course_name"), set.getString("course_code")
        };
        tableModel.addRow(row);
      }
    } catch (SQLException ex) {
  ...
  private void studentnumberActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_studentnumberActionPerformed
    // TODO add your handling code here:
  ...
  private void lastnameActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_lastnameActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_lastnameActionPerformed

  private void birthdateActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_birthdateActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_birthdateActionPerformed

  private void usernameActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_usernameActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_usernameActionPerformed

  private void Button1ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button1ActionPerformed
    // TODO add your handling code here:
    Database db = new Database();
    db.connect();
  ...
  private void Button2ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button2ActionPerformed
    Database db = new Database();
    db.connect();
  ...
  private void Button4ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button4ActionPerformed
    Database db = new Database();
    db.connect();

    String sql =
        "UPDATE Students SET first_name = '{first_name}', last_name = '{last_name}', email ="
            + " '{email}', birthdate = '{birthdate}' WHERE student_number = "
            + studentnumber.getText();
  ...
  private void Button8ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button8ActionPerformed
    Database db = new Database();
    db.connect();
  ...
  private void Button7ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button7ActionPerformed
    Database db = new Database();
    db.connect();
    String sql;
  ...
  private void Button6ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button6ActionPerformed
    Database db = new Database();
    db.connect();
  ...
  private void Button5ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button5ActionPerformed
    Database db = new Database();
    db.connect();
  ...
  private void coursecodeActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_coursecodeActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_coursecodeActionPerformed

  private void coursenameActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_coursenameActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_coursenameActionPerformed

  private void courseidActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_courseidActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_courseidActionPerformed

  private void email1ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_email1ActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_email1ActionPerformed

  private void Button3ActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_Button3ActionPerformed
    Database db = new Database();
    db.connect();
    String sql;
